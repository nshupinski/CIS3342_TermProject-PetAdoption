<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddPet.aspx.cs" Inherits="_3342_TermProject_PetAdoption.AddPet" %>
    ...
    <div class="bg">
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                  ...
                  <label for="breed_input"><small><b>Breed</b></small></label>
                  <asp:TextBox runat="server" id="breed_input" class="form-control col-md-11 input" type="text" Placeholder="Breed" required></asp:TextBox><br />
